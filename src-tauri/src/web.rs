...
use crate::commands::{
    ...
    check_paseo_processes, close_paseo_app, complete_login, delete_account,
    ...
    kill_paseo_processes, list_accounts, open_codex_app, open_paseo_app,
...
async fn invoke_web_command(command: &str, payload: Value) -> Result<Value, String> {
    match command {
        ...
        "close_paseo_app" => to_json(close_paseo_app().await?),
